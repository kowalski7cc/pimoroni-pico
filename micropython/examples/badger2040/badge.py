...
def draw_badge():
    ...
    while True:
        ...
        if name_length >= (TEXT_WIDTH - NAME_PADDING) and name_size >= 0.1:
            ...
            display.text(name, (TEXT_WIDTH - name_length) // 2,
                         (NAME_HEIGHT // 2) + COMPANY_HEIGHT + 1, name_size)
            break
    ...
    display.font("sans")
    display.thickness(2)
    display.text(detail1_text, LEFT_PADDING, HEIGHT - ((DETAILS_HEIGHT * 3)// 2), DETAILS_TEXT_SIZE)

    # Draw the second detail's title and text
    display.thickness(2)
    display.text(detail2_text, LEFT_PADDING, HEIGHT - (DETAILS_HEIGHT // 2), DETAILS_TEXT_SIZE)
...
detail1_text = truncatestring(detail1_text, DETAILS_TEXT_SIZE, TEXT_WIDTH)
detail2_text = truncatestring(detail2_text, DETAILS_TEXT_SIZE, TEXT_WIDTH)
